<template>
	<view class="uni-datetime-picker">
		<view @click="tiggerTimePicker">
			<slot>
				<view class="uni-datetime-picker-flex" :class="{'uni-datetime-picker-timebox':border}">
					{{time}}<view v-if="!time" class="uni-datetime-picker-time">{{placeholder}}</view>
					<view class="uni-datetime-picker-down-arrow" v-if="down"></view>
				</view>
			</slot>
		</view>
