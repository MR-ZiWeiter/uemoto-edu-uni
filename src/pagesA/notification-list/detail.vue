    ...
    <scroll-view class="context" scroll-y="true">
      <view class="content-box">
        <view class="title-info">
          ...
          <text class="time-text">{{renderInfo.createTime}}</text>
        </view>
...
@Component({
  methods: {
    ...mapActions({
      ...
      asyncFetchHomeNotiDetailInfo: 'asyncFetchHomeNotiDetailInfo'
    })
  }
})
export default class HomeSchoolInfoPage extends Vue {
  public title: string = '公告详情';
  ...
  private asyncFetchHomeNotiDetailInfo: () => Promise<ApiResponseModel>;
